...
- linker.lds (ajouts significatifs dans le code afin de configurer notre mémoire physique)
...
Le fichier **task.h** permet de sauvegarder des proprietés propres à chaque user grâce à une struct
